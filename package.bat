...
IF "%1" == "--nuitka" (
    IF "%2" == "--onefile" (
        python -m nuitka --follow-imports --standalone --enable-plugin=tk-inter --include-data-dir=assets=assets --windows-icon-from-ico=./assets/bg_cs_r_00.ico --show-progress --windows-console-mod=disable --onefile choose.py
    ) ELSE (
